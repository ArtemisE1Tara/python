...
# Add button to exit
Btn11 = tk.Button(LeftFrame, text = "Exit",command = Btn11_click,font=HFont)
Btn11.config(font=HFont)
...
Btn10 = tk.Button(RightFrame, text = "Export",command = Btn10_click)
Btn10.config(font=BFont)
Btn10.grid(column = 6, row = 3)
